...
class CodeFormerIdxModel(SRModel):
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            # Just for debugging
            if idx % 50 == 0:
                cv2.imwrite(f'debug_stage_2/{idx}_lr.png', tensor2img([self.input], rgb2bgr=True, min_max=(-1, 1)))
                cv2.imwrite(f'debug_stage_2/{idx}_sr.png', tensor2img([self.output], min_max=(-1, 1)))
